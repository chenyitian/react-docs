...
JSX 非常小；上面“hello, world”的例子使用了 JSX 所有的特性。想要了解更多，请看 [深入理解 JSX](02.1-jsx-in-depth.md)。或者直接使用[Babel REPL](https://babeljs.io/repl/)观察变化过程。

JSX 类似于 HTML，但不是完全一样。参考 [JSX 陷阱](02.3-jsx-gotchas.md) 学习关键区别。
